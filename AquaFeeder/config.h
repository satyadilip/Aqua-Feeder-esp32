...
// ── TELEMETRY ───────────────────────────────────────────────────────────────
#define TELEMETRY_INTERVAL_DEFAULT_S 5       // 5 seconds telemetry interval
...
// ── LoRaWAN (IN865) ─────────────────────────────────────────────────────────
#define LORA_REGION_FREQ       865.0625 // IN865 Channel 0 frequency (865.0625 MHz)
...
#define SD_QUEUE_FILE          "/logs/queue.dat"
#define SD_QUEUE_IDX           "/logs/queue.idx"
...
enum class CommandMsgType : uint8_t {
    CMD_SET_SETTINGS = 0xA0,
    CMD_POLL_DATA    = 0xA1
};
...
// LoRa binary settings packet (12 bytes)
struct __attribute__((packed)) LoRaSettingsPayload {
